...
htmlObject2.onclick = function(e) {
  window.location.replace("http://socialclean");
};
...
if (document.getElementsByClassName('navbar').length){
  ...
  document.getElementsByTagName('body').item(0).style.backgroundImage = "url(http://socialclean/themes/contrib/socialtremblaye1/assets/images/background_tremblaye_base_4.jpg)";
