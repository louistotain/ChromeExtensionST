...
htmlObject2.onclick = function(e) {
  window.location.replace("https://socialtest.tremblaye-sa.fr/ecran-dynamique");
};
...
if (document.getElementsByClassName('navbar').length){
  ...
  document.getElementsByTagName('body')[0].style = "background-image: url('../themes/contrib/socialtremblaye1/assets/images/background_tremblaye_base_4.jpg'); background-size: cover; color: rgb(71, 74, 77) !important;";
  ...
  document.getElementsByTagName('body').item(0).style.backgroundImage = "url('../themes/contrib/socialtremblaye1/assets/images/background_tremblaye_base_4.jpg')";
